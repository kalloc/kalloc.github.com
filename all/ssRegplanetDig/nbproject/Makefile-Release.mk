...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/ssregplanetdig

dist/Release/GNU-Linux-x86/ssregplanetdig: ${OBJECTFILES}
...
${OBJECTDIR}/dig.o: nbproject/Makefile-${CND_CONF}.mk dig.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/dig.o dig.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/ssregplanetdig
