...
function loadXML(url,query,reply) {
	...
	if(!string['WAIT']) string['WAIT']='Please Wait...';
    div.innerHTML='<div style="background-color:white" align="center"><img src="/js/ajax/loading_cursor.gif" width="16" height="16" border="0" alt="" valign="bottom"> <b>'+string['WAIT']+'</b><br/></div>';
    ...
    req.onreadystatechange = function() {
		...
		if(typeof(reply) == 'function') {
		        document.getElementsByTagName('body').item(0).removeChild(document.getElementById('watingzzzz'));
			reply(req);
...
function ajax_query(url,query,reply)
{
...
(function() { // to create local-scope variables
    ...
    JsHttpRequest.prototype = {
        ...
        session_name:       "SSID",  // set to SID cookie or GET parameter name
